      ...
      <div className="flex flex-col justify-between h-[calc(100vh-56px)]">
        ...
        <div className="container flex flex-col items-center justify-center my-4">
          ...
          This website was created by {" "}
            <strong>
              <a href="https://www.linkedin.com/in/mansi-sahu-352967266/" className="underline" target="_blank">
                Mansi sahu,
              </a>
            </strong>{" "}
            I welcome professional connections and opportunities—feel free to reach out.
            
          </p>
          <div className="flex flex-row items-center space-x-2">
            <span className="text-xs font-mono">Created by</span>
            <Link href="https://www.linkedin.com/in/mansi-sahu-352967266/" target="_blank">
             Mansi sahu
            </Link>
          </div>
        </div>
